...
```
*Generates summary metrics and writes markdown evaluation report to [`deepfake_robustness/outputs/comparative_robustness_report.md`](deepfake_robustness/outputs/comparative_robustness_report.md).*
